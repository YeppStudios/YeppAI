      ...
      <PageContent>
        ...
        <HeroSection>
          <Centered>
            <SlideBottom>
              <h1
                ...
                className="text-3xl lg:text-7xl max-w-4xl font-black text-center"
              >
                {" "}
                Turn your data into <ColorfulText>
                  quality content
                </ColorfulText>{" "}
                with AI
              </h1>
          ...
          <div>
            ...
            <Centered>
              {!mobile && (
                <div className="text-lg mt-4 text-center font-medium">
                  7 days for free <br />
                  <p className="text-sm font-normal">*up to 10 000 words</p>
                </div>
              )}
            </Centered>
            <Centered>
            ...
            <SlideBottom>
              ...
              {!mobile && (
                <div>
                  ...
                  <HeroText>
                    Reduce workload and watch your online presence{" "}
                    <ColorfulText>
                      <b className="font-black">grow.</b>
                    </ColorfulText>
                  </HeroText>
                </div>
              )}
              ...
              <Centered>
                <HeroText>
                  <p className="text-white">
                    What do marketing agencies say about Yepp?
                  </p>
                </HeroText>
              </Centered>
            </SlideBottom>
        ...
        <Section>
          ...
          <SlideBottom>
            <HeroText>Empower your team with AI.</HeroText>
          </SlideBottom>
        ...
        <Centered>
          <FreeConsultationBtn href="https://calendly.com/yeppai/yepp-introduction-call">
            Book a <ColorfulText>free demo</ColorfulText>
          </FreeConsultationBtn>
        </Centered>
        <Section>
...
const FreeConsultationBtn = styled.a`
  ...
  background-clip: padding-box, border-box;
  background: #f0f3f8;
  box-shadow: inset 2px 2px 6px rgba(22, 27, 29, 0.13),
    inset -2px -2px 4px #fafbff, 2px 2px 6px rgba(22, 27, 29, 0.23);
  align-items: center;
  background-size: 120%;
  background-position-x: -1rem;

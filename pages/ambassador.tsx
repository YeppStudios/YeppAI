    ...
    await api
      ...
      .then((res) => {
        showNotification({
          ...
          title: "Kod dodany!",
          message:
            "Kod został dodany pomyślnie. Nie zapomnij go udostępnić firmie.",
          color: "green",
    ...
    <div>
      ...
      {viewReferralModal && (
        <ReferralModal
          ...
          onClose={() => setViewReferralModal(false)}
        />
      )}
      <Link
        href="/"
        className="absolute top-5 left-10 lg:left-auto lg:top-6 lg:right-10 w-8 h-8 lg:w-10 lg:h-10"
      >
        <Image src={logoImage} alt="logo" style={{ width: "100%" }} />
      </Link>
            ...
            <div className="mt-6 lg:flex">
              <div className="lg:w-full lg:max-w-2xl lg:flex-auto">
                ...
                <p className="text-xl leading-8 mt-2 text-gray-600">
                  Yepp, is not a tool, we&apos;re a mission-driven community
                  shaping the future where marketing is both personal and
                  effective. <p className="mt-4">- Welcome on board ;)</p>
                </p>
                <button
                  onClick={() => setViewReferralModal(true)}
                  className="px-12 py-4 mt-4 bg-blue-600 text-white font-medium rounded-xl flex items-center"
                >
      ...
      <form
        onSubmit={(e) => addPromoCode(e)}
        className="px-10 bg-stone-100 lg:px-20 py-10 pb-20 w-full"
      >
        <div className="">
          <div>
            ...
            <p className="text-xl leading-8 mt-2 text-gray-600">
              Surprise your friend with a <b>20% promo code</b> for a Businss
              plan.
            </p>

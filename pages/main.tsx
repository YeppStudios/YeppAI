    ...
    return (
      <div>
        ...
        <PageContent>
          ...
          <HeroSection>
              <Centered><SlideBottom><h1 style={{lineHeight: "1.3"}} className='text-[9vw] px-4 inline-block lg:text-6xl max-w-6xl font-black text-center'>Generate marketing content {!mobile && <br />} based on your {!mobile && <TypewriterSection />}</h1></SlideBottom></Centered>

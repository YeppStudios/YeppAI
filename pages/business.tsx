...
import BusinessSignupBanner from '@/components/Landing/BusinessSignupBanner';
        ...
        <PageContent>
          ...
          <HeroSection>
              ...
              <DescriptionHero color="black">
                Twórz kreatywne treści nawet 10X szybciej i uwolnij siebie oraz swój zespół od powtarzalnych, czasochłonnych zadań!
              </DescriptionHero>
              <Centered>
                <LoginButton onClick={() => router.push("/chat")}>Zaloguj się</LoginButton>
              </Centered>
              <Centered>
                <TestButton onClick={() => router.push("/assets?registration=true&company=true")}><BsFillGiftFill /><TestText>Zacznij za darmo!</TestText></TestButton>
              </Centered>
          ...
          <ProFunctionalities>
            ...
            <LeftDescription>Firmowy model AI, który jest integralną częścią Twojego biznesu. Assistant Business oferuje Tobie:</LeftDescription>
            <RightFeature 
              title="Twoich Asystentów z każdego departamentu." 
              image={firstProFeature}
              text="Z firmowym asystentem departamenty mogą tworzyć swoje własne modele sztucznej inteligencji, które posiadając firmowe dane oraz zasilone informacjami branżowymi są w stanie zwiększyć efektywność pracy zespołów jednocześnie optymalizując czas wdrożenia nowych pracowników."
              color="white"
            />
            <LeftFeature
              title="Twój własny chat do obsługi klienta na stronie internetowej." 
              image={fifthProFeature} 
              text="Koniec ogromnych kosztów związanych z utrzymaniem obsługi klienta na najwyższym poziomie. Asystent Biznes zapewni Tobie własny Chat, który zaopiekuję się klientem w pierwszym kontakcie. Statystycznie aż 75% klientów wybiera ten sposób komunikacji."
              color="white"
              marginTop='0'
            />
            <RightFeature 
              ...
              text="Jaki sens ma zapisywanie zeszytów przez 12 lat nauki skoro i tak nigdy się do nich nie wraca? Z firmowym asystentem jest inaczej, dzięki przesłaniu mu wiedzy sporządzi on Tobie: Analizy, Raporty oraz Sprawozdanie dzięki czemu wykorzystasz lata statystyk na korzyść swojego Biznesu."
              color="white"
             />
            <LeftFeature 
              title="Twojego kreatywnego marketingowca." 
              image={thirdProFeature} 
              text="Wyobrażasz sobie, że masz swój własny model AI niczym z filmu tylko zamiast przejmować świat pomaga on Tobie złożyć treści marketingowe jak nikt inny. Jakość treści sprzedażowych w tym postów, maili czy opisów produktów jest zachowana poprzez ekspercką wiedzę o Twojej firmie."
              color="white"
              marginTop='0'
             />
            <RightFeature 

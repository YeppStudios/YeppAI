...
export const CampaignDropdown: FC<DropdownProps> = ({ category, values, openedCategory, setOpenedCategory, setAllChosenCategories }) => {
  ...
  return (
    ...
    className={
      "cursor-pointer appearance-none border-2 border-[#eaedf5] flex text-black items-center m-2 h-full pr-4 relative py-2 rounded-xl placeholder-[#DCDCDC] focus:outline-none text-md"
    }
  >
      <div
          ...
          {values.map((item, id) => {
            return (
              <div
                ...
                className="bg-white flex gap-2 items-center p-2 z-20 hover:bg-gray-50 rounded-xl cursor-pointer"
              >
                <div>

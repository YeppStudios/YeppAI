...
const styles = ["Formalny 💼", "Przyjazny 😊", "Treściwy 📃", "Przekonujący 🫵🏼"];
        ...
        if (query.type.includes("conspect")) {
            if(query.type.includes("blog")){
                ...
                if ( count === 1 ) {
                    ...
                    newTitle = `Wygenerowanie ${count} konspektów bloga`
                }
                ...
                if ( count === 1 ) {
                    newTitle = `Wygenerowanie konspektu artykułu`
                } else {
                    newTitle = `Wygenerowanie ${count} konspektów artykułu`
                }
            }
            ...
            if(query.type.includes("blog")){
                ...
                if ( count > 1 ) {
                    newTitle = `Wygenerowanie artykułu`
                } else {
                    newTitle = `Wygenerowanie ${count} artykułów`
                }
            }
                    ...
                    <Form onSubmit={(e) => generateContent(e)}>
                        ...
                        <InputContainer width="100%">
                            ...
                            <TextArea
                                ...
                                height= "8rem"
                                padding="0.6rem"
                                placeholder="Firma [nazwa] pozyskała dofinansowanie w wysokości [kwota] złotych na rozwój [produktu/usługi]..."
                                value={topic}

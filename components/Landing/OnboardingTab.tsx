        ...
        <div className="lg:px-[8rem] px-[0.5rem]">
            <div className="w-full bg-[#F3F4FA] rounded-3xl py-12 pb-16 lg:pb-16 px-5 lg:px-16 lg:py-16 lg:px-20 flex flex-wrap lg:grid lg:grid-cols-2 lg:gap-10">
                <div className="flex flex-col justify-center">
                    <h1 style={{lineHeight: "1.25"}} className="text-[1.75rem] lg:text-5xl font-bold text-center lg:text-left">See how you can <ColorfulText>drive traffic</ColorfulText> with Yepp</h1>

      ...
      <Container>
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="w-full">
            <p className="mt-2 text-[1.8rem] font-medium text-center text-white sm:text-3xl">
              Trusted by thousands of marketers worldwide
            </p>
          </div>
          
          <dl className="mt-10 text-white flex gap-28 justify-center">
            {stats.map((stat) => (
                ...
                <dd className="order-first text-4xl font-medium tracking-tight">{stat.value}</dd>
                </SlideBottom>
              </div>
            ))}
          </dl>

...
const plans = [
    {
        ...
        features: ["200 000 elixir/mo (~100 A4 pages)", "1 folder for assets", "10 assets to upload (max 15MB total)", "3 tones of voice", "3 buyer personas", "3 teammates", "Single web pages scanning", "Upload PDF, PPTX, TXT, CSV and DOCX", "Chat with your AI", "Marketing templates", "Copywriting feature"],
        price: 79,
        polishPrice: 299, 
    ...
    },
    {
        ...
        features: ["1M elixir/mo (~520 A4 pages)", "Unlimited folders for assets", "Unlimited number of assets", "Unlimited storage space", "Unlimited tones of voice", "Unlimited buyer personas", "Unlimited number of teammates", "Content Campaign feature", "Access to the latest features", "Dedicated customer support"], 
        price: 249, 
        polishPrice: 799, 

...
const footerNavigation = {
  ...
  social: [
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/company/yeppai/',
      icon: (props: any) => (
        <svg
...
const Footer = () => {
  ...
  return (
      <footer className="relative bg-[#F6F6FB] pt-28" aria-labelledby="footer-heading">
        ...
        <div className="w-[40%]">
          <FooterImage image="https://images.unsplash.com/photo-1590402494693-bd0499aefe00?auto=format&fit=crop&q=80&w=3270&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D">
        ...
        <div className="lg:pl-[10rem] lg:pr-[2rem] px-[5%] pb-8 font-medium">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8 flex flex-wrap">
            <div className="space-y-8">
              <Image
                ...
                alt="Company name"
              />
              <p className="text-sm leading-6 text-gray-800 pr-20">
          ...
          <div className="mt-16 lg:pr-[7rem] border-t border-white/10 pt-8 sm:mt-20 lg:mt-24 flex w-full justify-between">
            <p className="text-xs leading-5 text-gray-800">&copy; 2023 Yepp AI, Inc. All rights reserved.</p>
            <a className="text-xs leading-5 text-gray-800" href="/Yepp_AI_Terms.pdf">Privacy & Terms</a>
          </div>
        </div>
      </footer>
  );
...
const FooterImage = styled.div<{image: string}>`

        ...
        <NavContainer isFixed={isFixed} id="navbar">
            <Nav isFixed={isFixed}>
                <Container>
                    ...
                    <Link href="/"><AppName>Yepp <div className="text-base font-medium"><ColorfulText>Consulting</ColorfulText></div></AppName></Link>
                    <Link href="/why-yepp"><NavLink>Our mission</NavLink></Link>
                ...
                <Container>
                    {!(mobile && !isFixed) && <TestButton className='trial-btn' onClick={() => router.push("/demo")}>Book consultation</TestButton>}
                </Container>
            </Nav>
        </NavContainer>
        </div>

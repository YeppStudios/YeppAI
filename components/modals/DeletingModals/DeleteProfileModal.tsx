...
const DeleteProfileModal = (props: {onClose: any}) => {
    ...
    const deleteAsset = async () => {
        let profileId = localStorage.getItem("profile_id");
            try {
                setLoading(true);
                await api.delete(`/delete_profile/${profileId}`, {
                    headers: {
        ...
        <ModalBackground closeable={false}>
            ...
            <CloseIcon onClick={props.onClose}>
                ...
                <div>
                    ...
                    <Centered><Description>Profile will be permanently deleted and you will not be able to restore it.</Description></Centered>
                </div>   
                <Centered>

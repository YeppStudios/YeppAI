    ...
    <Combobox as="div" value={selected} onChange={handleChange}>
      <div className="relative">
        <Combobox.Input
          ...
          className="appearance-none border-2 border-[#F6F6FB]  flex text-black items-center pl-3 block w-full h-full pr-10 relative py-2 rounded-xl placeholder-[#DCDCDC] focus:outline-none text-md"
        ...
        {filteredValues.length > 0 && (
          <Combobox.Options
            ...
            className={`absolute z-50 mt-1 max-h-60 w-full overflow-auto rounded-xl border-[#F6F6FB] bg-white py-1 text-sm focus:outline-none sm:text-sm`}
          >
